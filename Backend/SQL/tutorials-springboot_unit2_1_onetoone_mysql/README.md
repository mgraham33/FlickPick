...
POST request: 
    ...
    3. /users - Create users without laptop. Request Format : application / json
    {
        "name" : "John",
        "email"  : "johndoe@somemail.com"
    }
...
GET request:
    ...
    2. /users/{id} - Get users object with associated laptop for provided users id
...
4. DELETE a record - 
 DELETE request:
    ...
    2. /users/{id} - delete a users with the id provided in the url
